#!/usr/bin/env python3
"""
Twitter MCP Server using twikit: https://github.com/gkydev/twitter-mcp-server
...
"""The new changes add ct0/auth_token fallback from environment variables and replace the older user_id()+user() 
sequence with twikit Client.user() for authentication. Adapted from a community Twitter MCP server to align with the 
latest twikit API and fix the previous argument-mismatch issue."""
    ...
    def setup_handlers(self):
        ...
        async def handle_call_tool(name: str, arguments: dict) -> list[types.TextContent]:
            ...
            try:
                ...
                ct0 = arguments.get("ct0") or os.getenv("TWITTER_CT0")
                auth_token = arguments.get("auth_token") or os.getenv("TWITTER_AUTH_TOKEN")
    ...
    async def _test_authentication(self, client: Client) -> Dict[str, Any]:
        ...
        return {
            ...
            "user": {
                ...
                "tweet_count": getattr(me, "statuses_count", None),
